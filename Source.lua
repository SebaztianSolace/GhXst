...
function Luna:CreateWindow(WindowSettings)
	...
	function Window:CreateHomeTab(HomeTabSettings)
		...
		HomeTabSettings = Kwargify({
			Icon = 1,
			SupportedExecutors = {"Ronix", "Delta", "Nihon", "Drift","Krnl"}, 
		...
		for i,v in pairs(HomeTabSettings.SupportedExecutors) do
			...
			if v == identifyexecutor() then
				...
				HomeTabPage.detailsholder.dashboard.Client.Subtitle.Text = "Your executor isn't officially supported by this script, or hasn't been tested with it."
				break
			end
		end
